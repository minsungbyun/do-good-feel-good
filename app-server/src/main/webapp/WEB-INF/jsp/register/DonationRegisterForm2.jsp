          ...
          <div class="join-wrap">
            <div class="wrapper">
              ...
              <fieldset class="section">
                ...
                <div class="four col">
                  <input type="radio" name="donationMoney" id="sam"><label for="sam">
                  <h6>30,000원</h6>
                  </label>
                </div>
                <div class="four col">
                  <input type="radio" name="donationMoney" id="oh"><label for="oh">
                  <h6>50,000원</h6>
                  </label>
                </div>
                <div class="four col">
                  <input type="radio" name="donationMoney" id="sib"><label for="sib">
                  <h6>100,000원</h6>
                  </label>
                </div>
                </div>
              ...
              <fieldset class="section">
                ...
                <c:forEach items="${payTypes}" var="donationRegisterPayType">
                 <label for="f-payType" class="container-radio" style="padding-right:9px;">카드결제
