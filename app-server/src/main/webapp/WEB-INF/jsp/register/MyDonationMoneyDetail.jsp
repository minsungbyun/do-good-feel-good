...
<body>
	...
	<form action='update'>
		<label for='f-no'>회원번호</label> <input id='f-no' type='text' name='no'
			...
			name='title' value='${joinDTO.donationMoney}'><br>

		<button>[변경]</button>
		<a href='list?no=${joinDTO.no}'>[기부자내역]</a> <a
			href='${contextPath}/donation/list'>[목록]</a> <a
			href='form?boardNo=${joinDTO.no}'>[해당 모금함 기부하기]</a> <a
			href='delete?no=${joinDTO.no}'>[삭제]</a><br>
	</form>
</body>
</html>
