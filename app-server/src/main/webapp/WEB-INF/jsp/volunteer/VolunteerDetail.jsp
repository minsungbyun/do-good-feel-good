  ...
  <main>
    <div class="page-section">
      <div class="container">
        ...
        <div class="vol-detail">
          ...
          <div class="vol-infor-wrap">
             ...
             <div class="vol-joiner">
              ...
              <button type="button" class="btn btn-outline-primary x-delete-btn" data-toggle="modal" data-target="#vol-Modal">
                봉사 참여자 목록
              </button>
            </div>
             </div>  <!-- //vol-joiner -->
       ...
       <div class="modal fade" id="vol-Modal" tabindex="-1" aria-labelledby="volModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="memberModalLabel">참여자목록</h5>
            </div>
