						...
						<form action='commentAdd' method="post">
							<div class="modal-body">
								<div class="class" id="id" style="display: none">
									<label for='f-volNo'>봉사번호</label> <input id='f-volNo'
										type='number' name='f-volNo'><br> <br>
								</div>
								<div class="class" id="id" style="display: none">
									<label for='f-content'>내용</label> <input id='f-content'
										type='text' name='content'><br> <br>
								</div>
								<button>수정완료</button>
								<br>
						</form>
