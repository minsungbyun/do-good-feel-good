        ...
        <div class="base-table">
          <form action='add' method="post" enctype="multipart/form-data">
            <table class="join-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><label for='f-startTime' class="sr-only">시작시간</label> <input
                    id='f-startTime' class="form-control box-input" type='time'
                    name='startTime'></td>
                </tr>
                <!-- //시작시간 -->
                <tr>
                ...
                <tr>
                  ...
                  <td><label for='f-limitNum' class="sr-only">총모집인원</label> <input
                    id='f-limitNum' class="form-control box-input" type='number'
                    name='limitNum'></td>
                </tr>
                <!-- //총모집인원 -->
                <tr>
            ...
            <div class="btn-regi">
              ...
              <a href="#" class="btn btn-outline-primary nBtn" onClick="history.go(-1)" role="button">이전</a>
            </div>
          </form>
