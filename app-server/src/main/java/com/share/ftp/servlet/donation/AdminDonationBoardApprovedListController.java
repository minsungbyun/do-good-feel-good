...
@WebServlet("/admin/approvedDonationList")
public class AdminDonationBoardApprovedListController extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response)
    ...
    try {
      ...
      RequestDispatcher 요청배달자 = request.getRequestDispatcher("/donation/AdminApprovedDonationBoardList.jsp");
