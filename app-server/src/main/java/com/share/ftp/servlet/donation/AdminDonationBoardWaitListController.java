...
@WebServlet("/admin/waitDonationList")
public class AdminDonationBoardWaitListController extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response)
    ...
    try {
      ...
      RequestDispatcher 요청배달자 = request.getRequestDispatcher("/donation/AdminWaitDonationBoardList.jsp");
