...
@WebServlet("/admin/rejectedDonationList")
public class AdminDonationBoardRejectedListController extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response)
    ...
    try {
      ...
      RequestDispatcher 요청배달자 = request.getRequestDispatcher("/donation/AdminRejectedDonationBoardList.jsp");
