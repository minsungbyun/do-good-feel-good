...
public class VolPersonalRejectTable extends JsonDataTable<PersonalRequestRejectDTO> implements DataProcessor {

  public VolPersonalRejectTable() {
    super("personalRequestRejectDTO.json",PersonalRequestRejectDTO.class);
  }
