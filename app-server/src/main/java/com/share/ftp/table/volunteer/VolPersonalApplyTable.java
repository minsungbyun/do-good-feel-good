...
public class VolPersonalApplyTable extends JsonDataTable<PersonalRequestApplyDTO> implements DataProcessor {

  public VolPersonalApplyTable() {
    super("personalRequestApplyDTO.json",PersonalRequestApplyDTO.class);
  }
