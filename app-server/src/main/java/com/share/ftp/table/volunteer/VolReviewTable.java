...
import com.share.ftp.domain.volunteer.VolReviewDTO;
...
public class VolReviewTable extends JsonDataTable<VolReviewDTO> implements DataProcessor {

  public VolReviewTable() {
    super("volReview.json",VolReviewDTO.class);
  }
