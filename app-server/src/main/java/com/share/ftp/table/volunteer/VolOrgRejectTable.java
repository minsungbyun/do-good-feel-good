...
public class VolOrgRejectTable extends JsonDataTable<OrgRequestRejectDTO> implements DataProcessor {

  public VolOrgRejectTable() {
    super("orgRequestRejectDTO.json",OrgRequestRejectDTO.class);
  }
