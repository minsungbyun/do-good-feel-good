...
public class VolOrgApplyTable extends JsonDataTable<OrgRequestApplyDTO> implements DataProcessor {

  public VolOrgApplyTable() {
    super("orgRequestApplyDTO.json",OrgRequestApplyDTO.class);
  }
