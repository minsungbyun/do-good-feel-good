...
public class AppConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(
    ...
    // 
    sqlSessionFactoryBean.setTypeAliasesPackage("com.share.ftp.domain");
    sqlSessionFactoryBean.setMapperLocations(
        appCtx.getResources("classpath:com/share/ftp/dao/*Dao.xml"));
