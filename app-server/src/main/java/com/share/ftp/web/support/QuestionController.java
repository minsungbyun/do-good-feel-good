...
public class QuestionController {
  ...
  public ModelAndView add(QuestionListDTO questionListDTO, HttpSession session) throws Exception {
  ...
  public ModelAndView update(QuestionListDTO questionListDTO) throws Exception {

    QuestionListDTO oldQuestionListDTO = questionDao.findByNo(questionListDTO.getNo());
    if (oldQuestionListDTO == null) {
      throw new Exception("해당 번호의 게시글이 없습니다.");
    } 
