...
@WebServlet("/admin/volunteer/waitList")
public class AdminVolunteerWaitListController extends HttpServlet { 
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      if (volunteerList == null) {
        throw new Exception("봉사가 없습니다.");
      }


      request.setAttribute("volunteerList", volunteerList);
      request.getRequestDispatcher("/admin/AdminVolunteerWaitList.jsp").forward(request, response);
