...
public class VolOrgRequestAppliedListHandler extends AbstractVolGeneralHandler { // 개인 봉사신청 양식 쓰는 곳


  public VolOrgRequestAppliedListHandler(
