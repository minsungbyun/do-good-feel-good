...
public abstract class Menu {
  ...
  public static final int ACCESS_PERSONAL = 0x02;    // 기관회원
  public static final int ACCESS_ORG = 0x04;  // 관리자
  public static final int ACCESS_ADMIN = 0x8; // 개인회원 + 기관회원
  public static final int ACCESS_MEMBER = 0x10; // 개인회원 + 기관회원
  public static final int ACCESS_MEMBER_ADMIN = 0x10; // 개인회원 + 기관회원 + 관리자
