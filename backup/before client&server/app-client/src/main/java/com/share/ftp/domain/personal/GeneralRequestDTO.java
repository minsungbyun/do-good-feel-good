...
public class GeneralRequestDTO implements Serializable {
  ...
  public String toString() {
    return "GeneralRequestDTO [volNo=" + volNo + ", memberType=" + memberType + ", volTitle="
        + volTitle + ", volName=" + volName + ", owner=" + owner + ", ownerId=" + ownerId
        + ", volType=" + volType + ", volTel=" + volTel + ", volEmail=" + volEmail
        + ", volStartDate=" + volStartDate + ", volEndDate=" + volEndDate + ", volStartTime="
        + volStartTime + ", volEndTime=" + volEndTime + ", volLimitNum=" + volLimitNum
        + ", volContent=" + volContent + ", volFileUpload=" + volFileUpload + ", isPersonal="
        + isPersonal + ", isSigned=" + isSigned + ", volSubmitTime=" + volSubmitTime + ", members="
        + members + ", totalJoinCount=" + totalJoinCount + "]";
  }

  @Override
  public int hashCode() {
    return Objects.hash(isPersonal, isSigned, memberType, members, owner, ownerId, totalJoinCount,
        volContent, volEmail, volEndDate, volEndTime, volFileUpload, volLimitNum, volName, volNo,
        volStartDate, volStartTime, volSubmitTime, volTel, volTitle, volType);
  }
  ...
  public boolean equals(Object obj) {
    ...
    return isPersonal == other.isPersonal && Objects.equals(isSigned, other.isSigned)
