...
public abstract class AbstractAdminChallengeQuestionHandler implements Command {

  protected List<ChallengeDTO> challengeDTOList;
  public AbstractAdminChallengeQuestionHandler(List<ChallengeDTO> challengeDTOList) {
