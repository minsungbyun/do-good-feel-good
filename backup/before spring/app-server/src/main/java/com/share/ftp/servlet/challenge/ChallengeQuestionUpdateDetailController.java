...
@WebServlet("/challenge/questionUpdateDetail")
public class ChallengeQuestionUpdateDetailController extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // 출력을 담당할 뷰를 호출한다.
      request.getRequestDispatcher("/challenge/ChallengeQuestionUpdateDetail.jsp").forward(request, response);
    } catch (Exception e) {
