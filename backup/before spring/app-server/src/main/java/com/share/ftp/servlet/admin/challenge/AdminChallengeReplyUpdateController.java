...
@WebServlet("/admin/challenge/replyUpdate")
public class AdminChallengeReplyUpdateController extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      challengeQuestionDTO.setReply(request.getParameter("reply"));
