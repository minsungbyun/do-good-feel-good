...
public class ClientApp {
  ...
  public ClientApp() throws Exception {
    ...
    commands.put("/volQuestion/update", new VolQuestionUpdateHandler(netChallengeDao));
    commands.put("/volQuestion/delete", new VolQuestionDeleteHandler(netChallengeDao));
